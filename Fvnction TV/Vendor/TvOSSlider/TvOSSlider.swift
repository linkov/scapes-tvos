...
private let trackViewHeight: CGFloat = 60
...
private let defaultTrackColor: UIColor = UIColor.init(white: 0.4, alpha: 0.8)
private let defaultMininumTrackTintColor: UIColor = .clear
